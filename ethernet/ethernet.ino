...
IPAddress ip(192,168,1,11); //IP address for your arduino.
...
void httpRequest()
{
  if (client.connect(server,80))
  {
    ...
    client.print(String("GET ") + "/server/tryjson.php/" + " HTTP/1.1\r\n" + "Host: " + server + "\r\n" + "Connection: close\r\n\r\n"); //GET request for server response.
...
void loop() 
{
  ...
  if(interrupt==0)
  {
      ...
      client.print("GET /server/info.php?"); //GET request to write data to the database.
      client.print("ID_S=");
      client.print(mod);
